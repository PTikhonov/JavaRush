...
*/
        ArrayList<String> lengthfilter = new ArrayList<String>();
        for (int i = 0; i < list.size(); i++)
        {
            String s = list.get(i);
            if ((s.length()%2) == 0) lengthfilter.add(s+" "+s);
            else lengthfilter.add(s+" "+s+" "+s);
        }



        for (int i = 0; i < lengthfilter.size(); i++)
        {
            System.out.println(lengthfilter.get(i));
        }
    }
}
